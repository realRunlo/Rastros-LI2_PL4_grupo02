...
//funcao que verifica se o jogador esta numa casa perto de derrota
int perto_derrota(ESTADO *e, int jogador){
    int c = get_coluna(get_ultima_jogada(e));
    int l = get_linha(get_ultima_jogada(e));

    if (jogador == 1 && ((c == 6 && (l == 7 || l == 6)) || (c == 7 && l == 6)) ) return 1;
    else if (jogador == 2 && ((c == 1 && (l == 1 || l == 0)) || (c == 0 && l == 1))) return 1;
    return 0;
